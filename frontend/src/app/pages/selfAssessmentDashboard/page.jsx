...
export default function AssessmentDashboard({ result }) {
  ...
  const totalPercentage = (result.totalScore / 30) * 100;
            ...
            <div className="bg-gradient-to-b from-slate-800 to-slate-900 rounded-3xl p-4 h-full shadow-lg">
              <div className="flex flex-col space-y-6">
                <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center shadow-sm">
                  <span className="text-slate-900 font-bold text-sm">WL</span>
                </div>
                ...
                <div className="w-10 h-10 hover:bg-slate-700 rounded-xl flex items-center justify-center cursor-pointer transition-all">
